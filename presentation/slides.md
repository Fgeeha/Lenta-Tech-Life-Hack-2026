...
**Значимость адаптивного сэмплера**: при 1 fps (шаг 1000 мс) производственная оценка
дала metric@80% = **0.000** — пропустила единственный читаемый кадр ts=15833 мс.
При 4 fps (шаг 250 мс) → 3/274 = 0.011. Окно QR-читаемости ≈ 150 мс.
